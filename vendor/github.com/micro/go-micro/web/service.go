...
func (s *service) Init(opts ...Option) error {
	...
	//k8s, 使用的是opts.Service 是grpc service
	s.opts.Service.Init(serviceOpts...)

	//创建新的web service时，已经调用了s.genSrv
	srv := s.genSrv()
	srv.Endpoints = s.srv.Endpoints
	s.srv = srv
